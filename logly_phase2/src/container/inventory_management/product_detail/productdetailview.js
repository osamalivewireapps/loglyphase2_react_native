            ...
            <View style={{
                ...
                >
                    ...
                    <TouchableOpacity onPress={() => { props.navigation.pop() }}>
                        <Image source={Icons.icon_whitebg_back} resizeMode='contain' style={{ margin: moderateScale(15), height: moderateScale(45), width: moderateScale(45) }} />
                    </TouchableOpacity>
                </View>
                    ...
                    <View style={{
                        ...
                        <AutoSizeText
                            ...
                            style={{
                                ...
                                textAlign: 'right',
                                fontFamily: Fonts.type.bold,
                            }}>{props.productData?.data?.quantity}
                        </AutoSizeText>
                    </View>
